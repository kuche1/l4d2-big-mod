void SetUpCVars()
{
    ...
    g_hCVar_MaxFinaleFailures      = CreateConVar(SETTING_MAX_COOP_FAILURES_CVAR_NAME, SETTING_MAX_COOP_FAILURES_DEFAULT_STR, SETTING_MAX_COOP_FAILURES_CVAR_DESC, 0, true, 0.0, false);
