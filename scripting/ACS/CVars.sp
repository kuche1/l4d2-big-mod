void SetUpCVars()
{
    ...
    g_hCVar_MaxFinaleFailures      = CreateConVar("acs_max_coop_finale_failures", CS_DEFAULT_MAX_COOP_FAILURES_STR, "The amount of times the survivors can fail a Coop map before it switches to the next campaign [0 = INFINITE FAILURES]", 0, true, 0.0, false);
...
void CVarChange_MaxFinaleFailures(Handle hCVar, const char[] strOldValue, const char[] strNewValue)
{
    ...
    if (iMaxFailures > 0)
    {
        g_iMaxCoopFailures = iMaxFailures;
