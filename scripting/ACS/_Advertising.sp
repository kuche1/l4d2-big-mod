...
//         (g_iGameMode == GAMEMODE_COOP || g_iGameMode == GAMEMODE_VERSUS) ? "The next campaign is currently " : "The next map is currently ",
...
//         PrintToChatAll("\x03[CS]\x05 %s\x04%s", strMessage, strMapName);
// }