...
{
    WriteFileLine(hFile, "// Campaign Switcher (CS) Map List Config File");
    WriteFileLine(hFile, "// ======================================================");
    WriteFileLine(hFile, "// This file was automatically generated by CS %s", PLUGIN_VERSION);
    WriteFileLine(hFile, "// ");
    ...
    WriteFileLine(hFile, "// 8) Check server console output to see if everything loaded into CS properly.");
    WriteFileLine(hFile, "// ");
