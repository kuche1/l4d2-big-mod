...
Show the current votes with `!campaignvotes`

## Installation

Run `build.sh` to compile the `.smx` file

Place the `.smx` file into the `left4dead2\addons\sourcemod\plugins` folder
